...
#define XR_LIST_ENUM_XrPlaneSourceXVISIO(_) \
    _(XR_PLANE_SOURCE_TOF_XVISIO, 0) \
    _(XR_PLANE_SOURCE_STEREO_XVISIO, 1) \
    _(XR_PLANE_SOURCE_TOF_NOSURFACE_XVISIO, 2) \
    _(XR_PLANE_SOURCE_MAX_ENUM_XVISIO, 0x7FFFFFFF)
...
#define XR_LIST_STRUCT_XvSkeletonXVISIO(_) \
    _(handPose) \
    _(poseSize) \

#define XR_LIST_STRUCT_XrObjectDataXVISIO(_) \
    _(point) \
    _(blobIndex) \
    _(typeID) \
    _(typeName) \
...
#define XR_LIST_STRUCT_XrGazePointXVISIO(_) \
    _(gazeBitMask) \
    _(gazePoint) \
    _(rawPoint) \
    _(smoothPoint) \
...
#define XR_LIST_STRUCT_XrGazePupilINFOXVISIO(_) \
    _(pupilBitMask) \
    _(pupilCenter) \
    _(pupilDistance) \
    _(pupilDiameter) \
...
#define XR_LIST_STRUCT_XrGazeDataXVISIO(_) \
    _(timestamp) \
    _(recommend) \
    _(gazePoints) \
    _(pupilInfo) \

#define XR_LIST_STRUCT_XrXplanPackageXVISIO(_) \
    _(points_nb) \
    _(idStr) \
    _(normal) \
    _(verticesSize) \
...
#define XR_LIST_STRUCT_XrSurfaceDataXVISIO(_) \
    _(mapId) \
    _(version) \
    _(id) \
    _(verticesSize) \
